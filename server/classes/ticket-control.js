...
class TicketControl {
    ...
    constructor() {
        ...
        this.tickets = []; //Contiene todos los tickets pendientes
        this.ultimos4 = [];
    ...
    atenderTicket(escritorio) {
        ...
        let atenderTicket = new Ticket(numeroTicket, escritorio); //crear ticket para atender
        this.ultimos4.unshift(atenderTicket); //Lo agrega al inicio del arreglo

        if (this.ultimos4.length > 4) { //verifica que solo haya 4 tickets
